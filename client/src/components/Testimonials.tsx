...
const testimonials: Testimonial[] = [
    {
        name: 'Cristina',
        relation: 'Fiica pacientei',
        initials: 'CP',
        color: 'from-rose-400 to-pink-500',
        quote: 'Am fost foarte stresată cu mama, sincer... e la pat și nu mai știam cum să mă descurc. De când am găsit MedAcasă, parcă s-a mai liniștit totul. Vin repede, sunt atenți și știu ce fac. Chiar îi recomand din suflet',
        rating: 5,
    },
    {
        name: 'Tudor',
        ...
        quote: 'Am evitat policlinica datorită serviciului acesta, chiar mi-a prins bine. Asistenții sunt profesioniști și foarte de treabă, m-am simțit în siguranță cu ei.',
        rating: 5,
    },
    {
        name: 'Elena',
        ...
        quote: 'După operație, tata a avut nevoie de pansamente des și nu știam cum o să ne descurcăm. MedAcasă a venit de fiecare dată la noi, la timp și cu tot ce trebuie. Recomand!',
        rating: 5,
    },
    {
        name: 'Victor',
        relation: 'Fiul pacientului',
        initials: 'VG',
        color: 'from-amber-400 to-orange-500',
        quote: 'Tata a avut nevoie de perfuzii. Am apelat la MedAcasă, cu ei e mult mai simplu, vin când avem nevoie și sunt foarte omenoși. Mulțumim mult pentru tot 🙏',
        rating: 5,
    },
];
